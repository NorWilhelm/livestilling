  ...
  var t = {
        ...
        (e.createTitle = function (t) {
          ...
          (e.createBracketContainer = function (t, e) {
            ...
            if (
              ...
              n.setAttribute("data-group-id", t.toString()),
              e)
            ) {
          ...
          (e.createMatchContainer = function (t, e) {
            ...
            return (
              ...
              void 0 !== t && n.setAttribute("data-match-id", t.toString()),
              void 0 !== e && n.setAttribute("data-match-status", e.toString()),
              n
            );
          }),
          ...
          (e.createParticipantContainer = function (t) {
            ...
            return (
              ...
              null != t && e.setAttribute("data-participant-id", t.toString()),
              e
            );
          }),
          ...
          (e.setupLoss = function (t, e, n) {
            ((n.result && "loss" === n.result) || n.forfeit) &&
              ...
              n.forfeit
                ? (e.innerText = (0, o.t)("abbreviations.forfeit"))
                : void 0 === n.score &&
                  (e.innerText = (0, o.t)("abbreviations.loss")));
          }),
          (e.addParticipantOrigin = function (t, e, n) {
            const r = document.createElement("span");
            "before" === n
              ? ((r.innerText = `${e} `), t.prepend(r))
              : "after" === n && ((r.innerText = ` (${e})`), t.append(r));
          }),
            ...
            return (
              "loser-bracket" === o
                ? ((c.connectPrevious =
                  ...
                  (c.connectNext =
                    e < n && (e % 2 == 0 ? "square" : "straight")))
                : ((c.connectPrevious = e > 1 && "square"),
                  (c.connectNext = e < n ? "square" : !!i && "straight")),
              t ||
                2 !== e ||
                (("single-bracket" === o || "winner-bracket" === o) &&
                  void 0 ===
                    (null === (a = r.opponent1) || void 0 === a
                      ? void 0
                      : a.position) &&
                  void 0 ===
                    (null === (s = r.opponent2) || void 0 === s
                      ? void 0
                      : s.position) &&
                  (c.connectPrevious = !1),
                "loser-bracket" === o &&
                  void 0 ===
                    (null === (u = r.opponent2) || void 0 === u
                      ? void 0
                      : u.position) &&
                  (c.connectPrevious = !1)),
              c
      ...
      886: function (t, e, n) {
        ...
        (e.splitBy = function (t, e) {
          ...
          (e.completeWithBlankMatches = function (t, e, n) {
            ...
            let r = [];
            return (
              ("single-bracket" !== t && "winner-bracket" !== t) ||
                (r = n
                  .map((t) => {
                    var e, n;
                    return [
          ...
          (e.getOriginAbbreviation = function (t, e, n, o) {
            return (
              (n = n || -1),
              (e && "loser-bracket" === t && 1 === n) ||
              "single-bracket" === t ||
              ("winner-bracket" === t && 1 === n)
                ? (0, r.t)("abbreviations.seed")
                : "loser-bracket" === t && n % 2 == 0 && "opponent1" === o
          ...
          (e.getRanking = function (t, e) {
            ...
            return (function (t) {
              ...
              for (const t of e)
                (t.rank = n.lastPoints !== t.points ? ++n.value : n.value),
      ...
      491: function (t, e, n) {
        ...
        (e.locales = { en: u.default, fr: c.default }),
          ...
          (e.addLocale = function (t, e) {
            o.default.addResourceBundle(t, "translation", e, !0, !0),
              o.default.changeLanguage();
          }),
          (e.t = l),
          (e.getOriginHint = function (t, e, n, r) {
            if (1 === t) {
              if ("single-bracket" === r)
                return (t) => l("origin-hint.seed", { position: t });
              if ("winner-bracket" === r)
                return (t) => l("origin-hint.seed", { position: t });
              if ("loser-bracket" === r && n)
                return (t) => l("origin-hint.seed", { position: t });
            }
            if ((0, s.isMajorRound)(t) && "loser-bracket" === r) {
              if (t === e - 2)
                return (t) =>
                  l("origin-hint.winner-bracket-semi-final", { position: t });
              ...
              return n
                ...
                : (t) =>
                    l("origin-hint.winner-bracket", { round: r, position: t });
            }
          }),
          ...
          (e.getMatchLabel = function (t, e, n, r) {
            ...
            if ("single-bracket" === r) {
              if (i)
                return l("match-label.standard-bracket-semi-final", {
                  matchNumber: t,
                });
          ...
          (e.getRoundName = function (t, e) {
            return t === e
              ? l("common.round-name-final")
              : l("common.round-name", { roundNumber: t });
          }),
          (e.getWinnerBracketRoundName = function (t, e) {
            return t === e
              ? l("common.round-name-winner-bracket-final")
              : l("common.round-name-winner-bracket", { roundNumber: t });
          }),
          (e.getLoserBracketRoundName = function (t, e) {
            return t === e
              ? l("common.round-name-loser-bracket-final")
              : l("common.round-name-loser-bracket", { roundNumber: t });
          });
      },
      825: function (t, e, n) {
        "use strict";
        ...
        e.BracketsViewer = class {
          ...
          async render(t, e) {
            ...
            (this.config = {
              participantOriginPlacement:
                (null == e ? void 0 : e.participantOriginPlacement) || "before",
              separatedChildCountLabel:
                void 0 !== (null == e ? void 0 : e.separatedChildCountLabel) &&
                e.separatedChildCountLabel,
              showSlotsOrigin:
                void 0 === (null == e ? void 0 : e.showSlotsOrigin) ||
                e.showSlotsOrigin,
              showLowerBracketSlotsOrigin:
                void 0 ===
                  (null == e ? void 0 : e.showLowerBracketSlotsOrigin) ||
                e.showLowerBracketSlotsOrigin,
              highlightParticipantOnHover:
                void 0 ===
                  (null == e ? void 0 : e.highlightParticipantOnHover) ||
                e.highlightParticipantOnHover,
            }),
              this.config.onMatchClick &&
          ...
          updateMatch(t) {
            ...
            u &&
              (null === (e = t.opponent1) || void 0 === e ? void 0 : e.score) &&
              (u.innerHTML =
                null ===
                  (r =
            ...
            c &&
              (null === (o = t.opponent2) || void 0 === o ? void 0 : o.score) &&
              (c.innerHTML =
                null ===
                  (a =
                    null === (i = t.opponent2) || void 0 === i
                      ? void 0
                      : i.score) || void 0 === a
                  ? void 0
                  : a.toString());
          ...
          renderStage(t, e) {
            ...
            switch (
              ((this.stage = n),
              (this.skipFirstRound = n.settings.skipFirstRound || !1),
              n.type)
            ) {
              case "round_robin":
          ...
          renderSingleElimination(t, e) {
            ...
            this.renderBracket(
              t,
              (0, s.splitBy)(e[0], "round_id"),
              c.getRoundName,
              "single-bracket"
            ),
              n && this.renderFinal(t, "consolation_final", e[1]);
          }
          renderDoubleElimination(t, e) {
            ...
            this.renderBracket(
              ...
              n &&
                this.renderBracket(
                  t,
                  (0, s.splitBy)(e[1], "round_id"),
                  c.getLoserBracketRoundName,
                  "loser-bracket"
                ),
              r && this.renderFinal(t, "grand_final", e[2]);
          }
          renderBracket(t, e, n, r, o) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              for (const t of l)
                c.append(
                  (t && this.createBracketMatch(s, a, t, r, o)) ||
          ...
          renderFinal(t, e, n) {
            ...
            for (let t = 0; t < a.length; t++) {
              const n = t + 1,
                o = u.createRoundContainer(
                  a[t].round_id,
                  c.getFinalMatchLabel(e, n, s)
                );
          ...
          skipBracketMatch() {
            ...
            return (
              e.append(n, r), t.append(e), (t.style.visibility = "hidden"), t
            );
          }
          createMatch(t, e, n, r, o, i) {
            ...
            return (
              this.renderMatchLabel(c, t, r),
              c.append(l, d),
              s.append(c),
              n ? (u.setupConnection(c, s, n), s) : s
            );
          }
          createParticipant(t, e, n, r, o) {
            ...
            return (
              null == t
                ? u.setupBye(i.name)
                : this.renderParticipant(i, t, e, n, r, o),
              i.participant.append(i.name, i.result),
              t && null !== t.id && this.setupMouseHover(t.id, i.participant),
              i.participant
            );
          }
          ...
          renderMatchLabel(t, e, n) {
            ...
            if (((n = n || ""), this.config.separatedChildCountLabel))
              return (
                t.append(u.createMatchLabel(n, c.getMatchStatus(e.status))),
                void (
                  e.child_count > 0 &&
                  t.append(
                    u.createChildCountLabel(
                      c.t("common.best-of-x", { x: e.child_count })
                    )
                  )
                )
              );
        ...
        e.BaseGetter = class {
          ...
          async getOrderedRoundsDoubleElimination(t) {
            ...
            return [
              o,
              ...i.filter((t) =>
                r.isOrderingSupportedLoserBracket(t.number, i.length)
              ),
            ];
          }
          ...
          async getPreviousMatches(t, e, n, r) {
            return "loser_bracket" === e
              ...
              : "final_group" === e
              ? this.getPreviousMatchesFinal(t, r)
              : 1 === r
              ? []
          ...
          async getMatchesBeforeMajorRound(t, e) {
            return [
              await this.findMatch(t.group_id, e - 1, 2 * t.number - 1),
              await this.findMatch(t.group_id, e - 1, 2 * t.number),
            ];
          }
          async getMatchesBeforeFirstRoundLB(t, e, n) {
            return [
              await this.findMatch(e, n, r.getOriginPosition(t, "opponent1")),
              await this.findMatch(e, n, r.getOriginPosition(t, "opponent2")),
            ];
          }
          ...
          async getNextMatchesWB(t, e, n, o) {
            ...
            return [
              ...(await this.getNextMatchesUpperBracket(t, e.type, n, o)),
              await this.findMatch(i.id, s, d),
            ];
          }
          ...
          async getSeedingMatches(t, e) {
            if ("round_robin" === e)
              return this.storage.select("match", { stage_id: t });
        ...
        class c extends a.BaseGetter {
          ...
          static async assertCanUpdateSeeding(t, e) {
            ...
            for (const i of t) {
              const t = e[o++],
                a = e[o++];
              if (
                u.isMatchParticipantLocked(i) &&
                ((null === (n = i.opponent1) || void 0 === n
                  ? void 0
                  : n.id) !== (null == t ? void 0 : t.id) ||
                  (null === (r = i.opponent2) || void 0 === r
                    ? void 0
                    : r.id) !== (null == a ? void 0 : a.id))
              )
          ...
          async updateMatch(t, e, n) {
            ...
            const o = u.isRoundRobin(r),
              { statusChanged: i, resultChanged: a } = u.setMatchResults(
                t,
                e,
                o
              );
          ...
          async applyMatchUpdate(t) {
            ...
            if (
              ((t.status <= r.Status.Ready || t.status === r.Status.Archived) &&
                (e.status = t.status),
          ...
          async archiveMatches(t) {
            for (const e of t)
              (e.status = r.Status.Archived), await this.applyMatchUpdate(e);
          }
          async resetMatchesStatus(t) {
            for (const e of t)
              (e.status = u.getMatchStatus(e)), await this.applyMatchUpdate(e);
          }
          async updateNext(t, e, n, r, o) {
            ...
            const a = u.getMatchResult(t),
              s =
                n.settings.skipFirstRound && "winner_bracket" === e ? r + 1 : r;
            a
          ...
          async applyToNextMatches(t, e, n, r, o, i, a) {
            ...
            if (
              (i[0] && (t(i[0], s, e, a), await this.propagateByeWinners(i[0])),
              2 === i.length)
            ) {
          ...
          async propagateByeWinners(t) {
            u.setMatchResults(t, t, !1),
              await this.applyMatchUpdate(t),
              u.hasBye(t) && (await this.updateRelatedMatches(t, !0, !0));
          }
        }
        e.BaseUpdater = c;
      },
        ...
        class i {
          ...
          async roundRobin() {
            ...
            for (let n = 0; n < t.length; n++)
              await this.createRoundRobinGroup(e, n + 1, t[n]);
            return e;
          }
          async singleElimination() {
            ...
            const n = await this.getSlots(),
              ...
              a = r.ordering[i](n),
              { losers: s } = await this.createStandardBracket(o, 1, a);
          ...
          async doubleElimination() {
            ...
            return (
              ...
              ? this.createDoubleEliminationSkipFirstRound(n, i)
              : this.createDoubleElimination(n, i);
          }
          async createDoubleEliminationSkipFirstRound(t, e) {
            var n;
            const { even: r, odd: i } = o.splitByParity(e),
              { losers: a, winner: s } = await this.createStandardBracket(
                t,
                1,
                r
              );
          ...
          async createDoubleElimination(t, e) {
            var n;
            const { losers: r, winner: i } = await this.createStandardBracket(
              t,
              1,
              e
            );
          ...
          async createRoundRobinGroup(t, e, n) {
            ...
            for (let e = 0; e < a.length; e++)
              await this.createRound(t, i, e + 1, a[0].length, a[e]);
          }
          ...
          async createLowerBracket(t, e, n) {
            var i;
            const a =
                null === (i = this.stage.settings) || void 0 === i
                  ? void 0
                  : i.size,
            ...
            for (let e = 0; e < s; e++) {
              ...
              (p = this.getCurrentDuels(p, r, !0)),
                await this.createRound(t, d, h++, r, p);
          ...
          async createMatch(t, e, n, r, i, a) {
            ...
            if ("round_robin" === this.stage.type && null === s && null === u)
              return;
            let c = null,
          ...
          async getSlots(t) {
            ...
            const r =
              (null === (e = this.stage.settings) || void 0 === e
                ? void 0
                : e.size) ||
              (null === (n = this.stage.seeding) || void 0 === n
                ? void 0
                : n.length) ||
              0;
            if ((o.ensureValidSize(r), r && !this.stage.seeding))
            ...
            return (
              ...
              o.ensureNoDuplicates(this.stage.seeding),
              (this.stage.seeding = o.fixSeeding(this.stage.seeding, r)),
              "round_robin" !== this.stage.type &&
                this.stage.settings.balanceByes &&
                (this.stage.seeding = o.balanceByes(
                  this.stage.seeding,
                  this.stage.settings.size
                )),
              o.isSeedingWithIds(this.stage.seeding)
                ? this.getSlotsUsingIds(this.stage.seeding, t)
                : this.getSlotsUsingNames(this.stage.seeding, t)
            );
          }
          ...
          async getStageNumber() {
            ...
            if (void 0 !== this.stage.number) {
              if (null == e ? void 0 : e.includes(this.stage.number))
          ...
          getOrdering(t, e, n) {
            ...
            if ("groups" === e && "natural" !== o && !o.match(/^groups\./))
              throw Error(
          ...
          async getRoundRobinGroups() {
            ...
            if (
              ...
              const t =
                  null === (a = this.stage.settings) || void 0 === a
                    ? void 0
          ...
          async insertStage(t) {
            ...
            return (
              this.updateMode &&
                (e = await this.storage.select("stage", this.currentStageId)),
              e ? e.id : this.storage.insert("stage", t)
            );
          }
          async insertGroup(t) {
            let e = null;
          ...
          async insertMatchGame(t) {
            ...
            if (
              (this.updateMode &&
                (e = await this.storage.selectFirst("match_game", {
                  parent_id: t.parent_id,
                  number: t.number,
                })),
              !e)
          ...
          async registerParticipants(t) {
            ...
            for (const n of t)
              if (
                ...
                -1 === (await this.storage.insert("participant", n))
              )
                return !1;
            return !0;
          }
          ...
          async ensureSeedOrdering(t) {
            ...
            if (
              ...
              !(await this.storage.update("stage", t, r)))
            )
      ...
      378: function (t, e) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.Delete = class {
            ...
            async stage(t) {
              if (!(await this.storage.delete("match_game", { stage_id: t })))
                throw Error("Could not delete match games.");
              if (!(await this.storage.delete("match", { stage_id: t })))
                throw Error("Could not delete matches.");
              if (!(await this.storage.delete("round", { stage_id: t })))
                throw Error("Could not delete rounds.");
              if (!(await this.storage.delete("group", { stage_id: t })))
                throw Error("Could not delete groups.");
              if (!(await this.storage.delete("stage", { id: t })))
        ...
        class i extends r.BaseGetter {
          ...
          async matchGames(t) {
            const e = t.filter((t) => t.child_count > 0),
              n = await Promise.all(
                e.map((t) =>
                  this.storage.select("match_game", { parent_id: t.id })
                )
              );
            if (n.some((t) => null === t))
          ...
          async seeding(t) {
            ...
            return "round_robin" === e.type
              ? this.roundRobinSeeding(e)
              : this.eliminationSeeding(e);
          }
          ...
          async singleEliminationStandings(t) {
            ...
            if (
              ...
              (n[2][0] = o.findParticipant(s, o.getWinner(t))),
                (n[2][1] = o.findParticipant(s, o.getLoser(t)));
            }
          ...
          async doubleEliminationStandings(t) {
            ...
            if (
              ...
              (r[0] = [o.findParticipant(u, o.getWinner(t))]),
                (r[1] = [o.findParticipant(u, o.getWinner(e))]);
            } else {
              const t = s.filter((t) => t.group_id === p.id),
                e = o.getGrandFinalDecisiveMatch(
                  (null === (n = c.settings) || void 0 === n
                    ? void 0
                    : n.grandFinal) || "none",
                  t
                );
              (r[0] = [o.findParticipant(u, o.getWinner(e))]),
                (r[1] = [o.findParticipant(u, o.getLoser(e))]);
            }
            const h = o.getLosers(
              u,
              s.filter((t) => t.group_id === d.id)
            );
      ...
      487: function (t, e, n) {
        ...
        function g(t) {
          ...
          return (
            void 0 !==
              (null === (e = t.opponent1) || void 0 === e ? void 0 : e.score) ||
            void 0 !==
              (null === (n = t.opponent2) || void 0 === n ? void 0 : n.score)
          );
        }
        function f(t) {
          return w(t) || m(t) || v(t);
          ...
          return (
            void 0 !==
              (null === (e = t.opponent1) || void 0 === e
                ...
                : e.forfeit) ||
            void 0 !==
              (null === (n = t.opponent2) || void 0 === n ? void 0 : n.forfeit)
          );
        }
        function v(t) {
          return y(t) || b(t);
          ...
          return (
            "draw" ===
              (null === (e = t.opponent1) || void 0 === e
                ...
                : e.result) &&
            "draw" ===
              (null === (n = t.opponent2) || void 0 === n ? void 0 : n.result)
          );
        }
        function b(t) {
          var e, n, r, o;
          return (
            ...
            "loss" ===
              (null === (r = t.opponent1) || void 0 === r
                ...
                : r.result) ||
            "loss" ===
              (null === (o = t.opponent2) || void 0 === o ? void 0 : o.result)
          );
        }
        function w(t) {
          var e, n;
          return (
            (null === t.opponent1 &&
              null !==
                (null === (e = t.opponent2) || void 0 === e ? void 0 : e.id)) ||
            (null === t.opponent2 &&
              null !==
                (null === (n = t.opponent1) || void 0 === n ? void 0 : n.id)) ||
        ...
        function S(t) {
          ...
          return k(a) ||
            (null ===
              (null === (e = a.opponent1) || void 0 === e ? void 0 : e.id) &&
              null ===
                (null === (n = a.opponent2) || void 0 === n ? void 0 : n.id))
            ? r.Status.Locked
            : null ===
                (null === (o = a.opponent1) || void 0 === o ? void 0 : o.id) ||
              null ===
                (null === (i = a.opponent2) || void 0 === i ? void 0 : i.id)
            ? r.Status.Waiting
            : f(a)
            ? r.Status.Completed
            : g(a)
        ...
        function O(t) {
          t.opponent1 &&
            ((t.opponent1.forfeit = void 0), (t.opponent1.result = void 0)),
            t.opponent2 &&
              ((t.opponent2.forfeit = void 0), (t.opponent2.result = void 0)),
            (t.status = S(t));
        }
        function M(t, e) {
          const n = t[e];
        ...
        function _(t, e) {
          var n, o, i, a;
          if (
            (null === (n = e.opponent1) || void 0 === n ? void 0 : n.score) ===
              (null === (o = t.opponent1) || void 0 === o ? void 0 : o.score) &&
            (null === (i = e.opponent2) || void 0 === i ? void 0 : i.score) ===
              (null === (a = t.opponent2) || void 0 === a ? void 0 : a.score)
          )
            return !1;
          const s = t.status;
          return (
        ...
        function P(t, e, n, r, o) {
          ...
          if (e.opponent1 && e.opponent2) {
            if ("win" === e.opponent1.result && "win" === e.opponent2.result)
              throw Error("There are two winners.");
            if ("loss" === e.opponent1.result && "loss" === e.opponent2.result)
              throw Error("There are two losers.");
            if (!o && !0 === e.opponent1.forfeit && !0 === e.opponent2.forfeit)
              throw Error("There are two forfeits.");
          }
          (null === (i = e.opponent1) || void 0 === i ? void 0 : i.result) ===
            n &&
            (t.opponent1
            ...
            (null === (a = e.opponent2) || void 0 === a ? void 0 : a.result) ===
              n &&
              (t.opponent2
        ...
        function L(t, e) {
          ...
          if (
            !0 ===
              (null === (n = e.opponent1) || void 0 === n
                ...
                : n.forfeit) &&
            !0 ===
              (null === (r = e.opponent2) || void 0 === r ? void 0 : r.forfeit)
          )
            return (
          ...
          !0 ===
            (null === (o = e.opponent1) || void 0 === o ? void 0 : o.forfeit) &&
            (t.opponent1 && (t.opponent1.forfeit = !0),
            t.opponent2
        ...
        function B(t) {
          ...
          if (
            (e.sort((t, e) => t.position - e.position), e.length === t.length)
          )
            return e;
        ...
        (e.splitByParity = function (t) {
          ...
          (e.makeRoundRobinDistribution = i),
          ...
          (e.makeGroups = function (t, e) {
            ...
            for (let e = 0; e < t.length; e++)
              e % n == 0 && r.push([]), r[r.length - 1].push(t[e]);
            return r;
          }),
          (e.balanceByes = function (t, e) {
            if (
              ...
              return u(t.map((t) => [t, null]).flat(), e, null);
            const n = t.length,
              r = e - n,
              o = t
                .slice(0, n - r)
          ...
          (e.makeNormalizedIdMapping = a),
          (e.normalizeParticipant = s),
          (e.setArraySize = u),
          ...
          (e.ensureValidSize = function (t) {
            ...
            if (!Number.isInteger(Math.log2(t)))
              throw Error(
          ...
          (e.ensureNotTied = function (t) {
            if (t[0] === t[1])
              throw Error(`${t[0]} and ${t[1]} are tied. It cannot be.`);
          }),
          (e.convertTBDtoBYE = function (t) {
            return null === t || null === (null == t ? void 0 : t.id)
              ? null
              : t;
          }),
          ...
          (e.getOtherSide = h),
          (e.isMatchStarted = g),
          (e.isMatchCompleted = f),
          (e.isMatchForfeitCompleted = m),
          (e.isMatchResultCompleted = v),
          (e.isMatchDrawCompleted = y),
          (e.isMatchWinCompleted = b),
          (e.isMatchByeCompleted = w),
          ...
          (e.setMatchResults = function (t, e, n) {
            ...
            const i = _(t, e);
            return r && o
              ? (C(t, e, n), { statusChanged: !1, resultChanged: !0 })
              : r && !o
              ? (C(t, e, n), { statusChanged: !0, resultChanged: !0 })
              : !r && o
              ? (O(t), { statusChanged: !0, resultChanged: !0 })
              : { statusChanged: i, resultChanged: !1 };
          }),
          (e.resetMatchResults = O),
          (e.getOpponentId = M),
          ...
          (e.setNextOpponent = function (t, e, n, r) {
            ...
            (t[e] = n[r] && {
              id: M(n, r),
              position:
                null === (o = t[e]) || void 0 === o ? void 0 : o.position,
            }),
              (t.status = S(t));
          }),
          (e.resetNextOpponent = function (t, e) {
            ...
            (t[e] = t[e] && {
              id: null,
              position:
                null === (n = t[e]) || void 0 === n ? void 0 : n.position,
            }),
              (t.status = r.Status.Locked);
          }),
              ...
              ...(n
                ? {
                    opponent1:
                      null === t.opponent1
                        ? null
                        : { ...e.opponent1, ...t.opponent1 },
                    opponent2:
                      null === t.opponent2
                        ? null
                        : { ...e.opponent2, ...t.opponent2 },
                  }
                : {
                    opponent1:
                      null === t.opponent1
          ...
          (e.getSeedCount = F),
          (e.ensureOrderingSupported = D),
          (e.isOrderingSupportedUpperBracket = T),
          (e.isOrderingSupportedLoserBracket = A),
          (e.getUpperBracketRoundCount = I),
          (e.getRoundPairCount = U),
          ...
          (e.getNearestPowerOfTwo = W),
          (e.minScoreToWinBestOfX = z),
          (e.isRoundRobin = H),
      ...
      76: function (t, e, n) {
        ...
        e.BracketsManager = class {
          ...
          async import(t, e = !1) {
            ...
            if (!(await this.storage.insert("match_game", t.match_game)))
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.ordering = {
            ...
            inner_outer: (t) => {
              ...
              for (let t = 0; t < e / 2; t++)
                a(r, "outer"), a(n, "inner"), a(r, "inner"), a(n, "outer");
              return i;
            },
          ...
          async matchResults(t) {
            ...
            if (
              (await this.getNextMatches(e, u, n, a, s)).some(
                (t) =>
                  t && t.status >= r.Status.Running && !i.isMatchByeCompleted(t)
              )
            )
              throw Error("The match is locked.");
            i.resetMatchResults(e),
              await this.applyMatchUpdate(e),
              i.isRoundRobin(n) || (await this.updateRelatedMatches(e, !0, !0));
          }
          ...
          async applyRoundOrdering(t, e, n) {
            for (const r of e) {
              ...
              if (
                ...
                1 === t && (o.opponent2 = a.findPosition(e, n.shift())),
          ...
          update(t, e, n) {
            ...
            return r
              ? (r.forEach((e) => {
                  ...
                  for (const t in n)
                    r[t] && "object" == typeof r[t] && "object" == typeof n[t]
              ...
              e.lookupCookie &&
                ...
                (function (t, e, n, r) {
                  ...
                  n &&
                    ...
                    r && (o.domain = r),
                    (document.cookie = l(t, encodeURIComponent(e), o));
                })(
                  e.lookupCookie,
                  t,
                  e.cookieMinutes,
                ...
                },
                {
                  ...
                  value: function (t, e, n) {
                    ...
                    return s || !i || "string" != typeof n
                      ? s
                      : z(this.data && this.data[t] && this.data[t][e], n, o);
                  },
                },
                {
                  key: "addResource",
                  ...
                  },
                  {
                    ...
                    value: function (t, e, n) {
                      ...
                      if (
                        ...
                        (f = f.join(w)) &&
                          (f = this.extendTranslation(f, t, e, n));
                      else {
                        var _ = !1,
                          C = !1,
                        ...
                        !this.isValidLookup(f) && L && ((_ = !0), (f = B)),
                        ...
                        if (C || _ || D) {
                          ...
                          var G = function (t, n, o) {
                            ...
                            r.options.missingKeyHandler
                              ? r.options.missingKeyHandler(t, c, n, i, D, e)
                              : r.backendConnector &&
                                  ...
                                  r.pluralResolver
                                    ...
                                    .forEach(function (n) {
                                      G(
                                        [t],
                                        s + n,
                                        e["defaultValue".concat(n)] || B
                                      );
                                    });
                                })
                              : G(A, s, B));
                        }
                        (f = this.extendTranslation(f, t, e, g, n)),
                          C &&
                            f === s &&
                        ...
                        t.forEach(function (t) {
                          if (!a.isValidLookup(e)) {
                            ...
                            l.forEach(function (t) {
                              a.isValidLookup(e) ||
                                ((i = t),
                                !K["".concat(g[0], "-").concat(t)] &&
                                  a.utils &&
                                  a.utils.hasLoadedNamespace &&
                                  !a.utils.hasLoadedNamespace(i) &&
                                  ((K["".concat(g[0], "-").concat(t)] = !0),
                                  a.logger.warn(
                                    'key "'
                                  ...
                                  if (!a.isValidLookup(e)) {
                                    ...
                                    if (
                                      ...
                                      if (
                                        ...
                                        u.push(f),
                                          d &&
                                            (u.push(f + l), p && u.push(f + g));
                                      }
                                    }
                                    for (; (i = u.pop()); )
                                      a.isValidLookup(e) ||
                                        ((r = i),
                                        (e = a.getResource(n, t, i, s)));
                                  }
                                }));
                            });
                          }
          ...
          return (
            Q.forEach(function (e) {
              e.lngs.forEach(function (n) {
                t[n] = { numbers: e.nr, plurals: Z[e.fc] };
              });
            }),
            t
          );
                ...
                value: function (t, e, n, r) {
                  ...
                  var l = function (t) {
                    if (t.indexOf(s.formatSeparator) < 0) {
                      ...
                      return s.alwaysFormat
                        ? s.format(
                            ...
                            void 0,
                            n,
                            it(it(it({}, r), e), {}, { interpolationkey: t })
                          )
                        : o;
                    }
                    ...
                    return s.format(
                      ...
                      c,
                      n,
                      it(it(it({}, r), e), {}, { interpolationkey: a })
                    );
                  };
                  this.resetRegExp();
                  var d =
            ...
            g.default(this, t),
              ...
              (this.formats = {
                ...
                relativetime: function (t, e, n) {
                  return new Intl.RelativeTimeFormat(e, ut({}, n)).format(
                    t,
                    n.range || "day"
                  );
                },
                            ...
                            : o.split(";").forEach(function (t) {
                                if (t) {
                                  var e = t.split(":"),
                                    ...
                                    o = r[0],
                                    i = r.slice(1).join(":");
                                  n[o.trim()] || (n[o.trim()] = i.trim()),
                                    "false" === i.trim() && (n[o.trim()] = !1),
                                    "true" === i.trim() && (n[o.trim()] = !0),
                                    isNaN(i.trim()) ||
                                      (n[o.trim()] = parseInt(i.trim(), 10));
                                }
                              });
                        }
          ...
          function o() {
            ...
            if (
              ...
              if (!t.options.initImmediate)
                return t.init(e, n), y.default(t, m.default(t));
              setTimeout(function () {
                t.init(e, n);
              }, 0);
            }
            ...
            f.default(o, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ((this.options = mt(mt(mt({}, r), this.options), gt(e))),
                    "v1" !== this.options.compatibilityAPI &&
                      (this.options.interpolation = mt(
                        mt({}, r.interpolation),
                        this.options.interpolation
                      )),
                    void 0 !== e.keySeparator &&
                    ...
                    var i;
                    this.modules.logger
                      ? R.init(o(this.modules.logger), this.options)
                      : R.init(null, this.options),
                      this.modules.formatter
                        ? (i = this.modules.formatter)
                        : "undefined" != typeof Intl && (i = ct);
        ...
        t.exports = function (t) {
          return (t = t || {}).circles
            ? (function (t) {
                  ...
                  ? function t(i) {
                      ...
                      for (var s in (n.push(i), r.push(a), i)) {
                        ...
                        if ("object" != typeof u || null === u) a[s] = u;
                          ...
                          a[s] = new Map(o(Array.from(u), t));
                        else if (u instanceof Set)
                          a[s] = new Set(o(Array.from(u), t));
                ...
                function o(t, o) {
                  for (
                    var i = Object.keys(t), a = new Array(i.length), s = 0;
                    s < i.length;
                    s++
                  ) {
                    var u = i[s],
          ...
          function n(t, n) {
            for (
              var r = Object.keys(t), o = new Array(r.length), i = 0;
              i < r.length;
              i++
            ) {
              var a = r[i],
